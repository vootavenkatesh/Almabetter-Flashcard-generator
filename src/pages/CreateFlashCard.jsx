          ...
          <div className="md:flex flex-col px-10 py-4 bg-white drop-shadow-lg space-y-4 rounded-lg">
            <div className="flex flex-col sm:flex-row items-center space-x-10 pt-3">
              <div className="flex flex-col relative">
                ...
                <Field
                  ...
                  className="border-gray-300 md:w-96 border-4 rounded-lg focus:ring-gray-500 focus:border focus:border-gray-700"
                />
            ...
            <div className="flex flex-col w-full sm:w-[70%]">
              ...
              <Field
                ...
                className="resize-none border-gray-300 border-4 rounded-lg  focus:ring-gray-400 focus:border focus:border-gray-400"
              />
                    ...
                    {cards && cards.length > 0
                      ? cards.map((cards, index) => (
                          ...
                          >
                            ...
                            <div className="flex flex-col space-y-3 md:space-x-10 md:flex-row">
                              <div className="relative flex flex-col justify-center space-y-3">
                                ...
                                <Field
                                  ...
                                  className="border-gray-300 md:w-56 border-4 rounded-lg focus:ring-gray-500 focus:border focus:border-gray-700"
                                />
                                <ErrorMessage
                                  component={TextError}
                                  name={`cards.${index}.cardname`}
                              ...
                              <div className="relative flex flex-col justify-center space-y-3">
                                ...
                                <Field
                                  ...
                                  className=" lg:w-72  resize-none border-gray-300 border-4 rounded-lg  focus:ring-gray-400 focus:border focus:border-gray-400"
                                />
                                <ErrorMessage
                                  component={TextError}
                                  name={`cards.${index}.carddescription`}
                            ...
                            //   type="button"
                            //   onClick={() => filePickerRef.current.click()}
                            //   className={`md:flex items-center px-2 py-2 mt-6 bg-white border-2 border-slate-300 active:border-blue-600 text-blue-700 font-semibold rounded-md space-x-2 `}
                            //  // className={`md:flex items-center px-10 py-2 mt-6 bg-white border-2 border-slate-300 active:border-blue-600 text-blue-700 font-semibold rounded-md space-x-2 `}
                            //   enabled={true}
                            // >
                            //   <AiOutlineUpload className="w-6 h-6"/>
